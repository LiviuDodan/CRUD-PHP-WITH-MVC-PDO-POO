    ...
    <div class="form-group">
        <form action="" method="post">
          <label for="nombreCliente">Nombre del cliente</label>
            ...
            <?php
            if ($clientes==null){
              echo '<option value="0">No hay datos en la tabla clientes</option>';
            }
            ...
            <input type="text" class="form-control" name="txtNombreMecanico" id="nombre" value="<?php echo $nombreMecanico; ?>" maxlength="40"><br>

            
            <a href="../../views/mecanicos/index.php" class="btn btn-primary">Volver</a>
            <input type="submit" name="crear" value="Insertar" class="btn btn-success"><br>
            <?php echo $mensaje; ?>
        </form>
    </div>
    <!-- Optional JavaScript -->
